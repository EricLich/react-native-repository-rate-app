...
const RepositoryStats = (props) => {
  return (
    <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
      <View>
        <StyledText align={"center"} fontWeight={"bold"}>Stars⭐️:</StyledText>
      ...
      <View>
        <StyledText align={"center"} fontWeight={"bold"}>Review Count: </StyledText>
        <StyledText align={"center"}>{parseThousands(props.repo.reviewCount)}</StyledText>
      </View>
      <View>
        <StyledText align={"center"} fontWeight={"bold"}>Rating Average: </StyledText>
        <StyledText align={"center"}>{parseThousands(props.repo.ratingAverage)}</StyledText>
      </View>
    </View>
  );
};
